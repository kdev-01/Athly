  ...
  return (
    <div className="min-h-screen w-full bg-gray-100 p-6">
      ...
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-gray-800">Gestión de Eventos Deportivos</h1>
        {!selectedEvent && (
          <button
            ...
            events.map((event) => (
              ...
              >
                <EventCard
                  ...
                  sportName={event.sport ? event.sport.name : "Desconocido"}
                  categoryName={event.category ? event.category.name : "Desconocida"}
                />
              </div>
            ))
          ) : (
