...
const EventCard = ({ eventName, startDate, endDate, sportName, categoryName, onClick }) => {
    ...
    >
      ...
      <div className="bg-gray-50 p-4">
        <p className="text-gray-700">
          <strong className="text-gray-900">Fecha de Inicio:</strong> {startDate}
        </p>
        <p className="text-gray-700">
          <strong className="text-gray-900">Fecha de Fin:</strong> {endDate}
        </p>
        <p className="text-gray-700">
          <strong className="text-gray-900">Deporte:</strong> {sportName}
        </p>
        <p className="text-gray-700">
          <strong className="text-gray-900">Categoría:</strong> {categoryName}
        </p>
      </div>
